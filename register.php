            ...
            <div class="card-body">
                <form action="register_a.php" method="post">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="password" class="form-control" placeholder=" Confirm password" name="cpass" required="required">
                    </div>
                    <div class="row align-items-center remember">
                        <input type="checkbox">Remember Me
                    </div>
                    <div class="form-group">
                        <input type="submit" name="save" value="Register" class="btn float-right login_btn">
                    </div>
                </form>
            </div>
