...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to Raktkosh </h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Donating blood can help people with many health conditions, such as those who:
...
need treatments involving plasma or other blood products. </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</p>
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="chat_project/index.php">Chat Box</a>
            </div>
        </div>
